        ...
        <modal v-if="showModal" @close="showModal = false">
            ...
            <div slot="body">
                ...
                <div class="row dates-row">
                    ...
                    <div class="col-md-8">
                        <date-picker v-model="project_modal_data.dates.contract.work" range lang="ru"
                                     format="YYYY-MM-DD" range-separator="-" confirm></date-picker>
                    </div>
                </div>
                <div class="row dates-row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-8">
                        <date-picker v-model="project_modal_data.dates.contract.report" lang="ru" format="YYYY-MM-DD"
                                     confirm></date-picker>
                    </div>
                </div>
                ...
                <div class="row dates-row">
                    ...
                    <div class="col-md-8">
                        <date-picker v-model="project_modal_data.dates.real.adm" range lang="ru" format="YYYY-MM-DD"
                ...
                <div class="row dates-row">
                    ...
                    <div class="col-md-8">
                        <date-picker v-model="project_modal_data.dates.real.work" range lang="ru" format="YYYY-MM-DD"
                ...
                <div class="row dates-row">
                    ...
                    <div class="col-md-4">
                        <date-picker v-model="project_modal_data.dates.real.report[0]" lang="ru" format="YYYY-MM-DD"
                                     range-separator="-" confirm></date-picker>
                    </div>
                    <div class="col-md-4">
                        <date-picker v-model="project_modal_data.dates.real.report[1]" lang="ru" format="YYYY-MM-DD"
                                     range-separator="-" confirm></date-picker>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <multiselect v-model="project_modal_data.group" placeholder="Назначьте бригаду" label="name"
                                     :searchable="true" track-by="id" :options="sgroups"></multiselect>
                    </div>
                </div>
            </div>
